...
DimBlcks[ 7].UpBtn.IcpInChnIndx =  93; DimBlcks[ 7].DownBtn.IcpInChnIndx =  94; DimBlcks[ 7].DimChnIndx = 9; // Спальня (бра 1)
DimBlcks[ 8].UpBtn.IcpInChnIndx = 117; DimBlcks[ 8].DownBtn.IcpInChnIndx = 119; DimBlcks[ 8].DimChnIndx = 8; // Спальня (бра 2)
DimBlcks[ 9].UpBtn.IcpInChnIndx = 118; DimBlcks[ 9].DownBtn.IcpInChnIndx = 120; DimBlcks[ 9].DimChnIndx = 7; // Спальня (бра 3)
DimBlcks[10].UpBtn.IcpInChnIndx = 115; DimBlcks[10].DownBtn.IcpInChnIndx = 116; DimBlcks[10].DimChnIndx = 8; // Спальня (бра 2)
DimBlcks[11].UpBtn.IcpInChnIndx = 113; DimBlcks[11].DownBtn.IcpInChnIndx = 114; DimBlcks[11].DimChnIndx = 7; // Спальня (бра 3)
DimBlcks[12].UpBtn.IcpInChnIndx =  77; DimBlcks[12].DownBtn.IcpInChnIndx =  78; DimBlcks[12].DimChnIndx = 2; // Детская
DimBlcks[13].UpBtn.IcpInChnIndx =  73; DimBlcks[13].DownBtn.IcpInChnIndx =  74; DimBlcks[13].DimChnIndx = 3; // Детская (бра)
DimBlcks[14].UpBtn.IcpInChnIndx =  81; DimBlcks[14].DownBtn.IcpInChnIndx =  82; DimBlcks[14].DimChnIndx = 3; // Детская (бра)
DimBlcks[15].UpBtn.IcpInChnIndx = 133; DimBlcks[15].DownBtn.IcpInChnIndx = 134; DimBlcks[15].DimChnIndx = 5; // Ванная
DimBlcks[16].UpBtn.IcpInChnIndx =  20; DimBlcks[16].DownBtn.IcpInChnIndx =  19; DimBlcks[16].DimChnIndx = 5; // Ванная
